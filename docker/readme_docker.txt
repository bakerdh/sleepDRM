...
5. Call the container something sensible (i.e. sleep), set the host port to 8787, and add an Environment variable called PASSWORD with the value: pass
...
git clone https://github.com/bakerdh/sleepDRM.git
This will download the repository to a folder called sleepDRM
