...
packagelist <- c('bookdown','knitr','markdown','osfr','plyr','tidyr','dplyr','emmeans','ggplot2','Rmisc','buildmer','lme4','lmerTest','stringr','effects','effectsize','ggdist','car','gridExtra','kableExtra','rstatix','LSAfun','simr','effsize','readr', 'Gmisc', 'glue', 'htmlTable', 'grid', 'magrittr', 'tidyverse', 'magick', 'cowplot')
...
```{r expprocedure-pdf, include=FALSE}

if (buildfigures==1){
#make boxes
immediate_group <- boxGrob(glue("Immediate Groups"),
                           txt_gp = gpar(col = "black", fontsize = 16),
                           box_gp = gpar(fill = 0, col = 0),
                           x = .25,
                           y = .93,
                           bjust = "center")

delay_group <- boxGrob(glue("Delay Groups"),
                       txt_gp = gpar(col = "black", fontsize = 16),
                       box_gp = gpar(fill = 0, col = 0),
                       x = .75,
                       y = .93,
...
group_am <- boxGrob(glue("AM-Control Group"),
                    txt_gp = gpar(col = "black", fontface = "bold"),
                    box_gp = gpar(fill = "#fee59d", col = "#fee59d"),
                    y = .8,
                    x = .15,
                    width = unit(0.175, "npc"),
                    height = unit(0.05, "npc"),
                    bjust = "center")

group_pm <- boxGrob(glue("PM-Control Group"),
                    txt_gp = gpar(col = "black", fontface = "bold"),
                    box_gp = gpar(fill = "#3276b4", col = "#3276b4"),
                    y = .8,
                    x = .35,
                    width = unit(0.175, "npc"),
                    height = unit(0.05, "npc"),
...
group_wake <- boxGrob(glue("Wake Group"),
                      txt_gp = gpar(col = "black", fontface = "bold"),
                      box_gp = gpar(fill = "#fff1ce", col = "#fff1ce"),
                      y = .8,
                      x = .65,
                      width = unit(0.175, "npc"),
                      height = unit(0.05, "npc"),
...
group_sleep <- boxGrob(glue("Sleep Group"),
                       txt_gp = gpar(col = "black", fontface = "bold"),
                       box_gp = gpar(fill = "#5e9cd3", col = "#5e9cd3"),
                       y = .8,
                       x = .85,
                       width = unit(0.175, "npc"),
                       height = unit(0.05, "npc"),
...
start_am <- boxGrob(glue("9AM Start"),
                    txt_gp = gpar(col = "black"),
                    box_gp = gpar(fill = 0, col = 0),
                    y = .7,
                    x = .15,
                    width = unit(0.1, "npc"),
...
start_pm <- boxGrob(glue("9PM Start"),
                    txt_gp = gpar(col = "black"),
                    box_gp = gpar(fill = 0, col = 0),
                    y = .7,
                    x = .35,
...
start_wake <- boxGrob(glue("9AM Start"),
                      txt_gp = gpar(col = "black"),
                      box_gp = gpar(fill = 0, col = 0),
                      y = .7,
                      x = .65,
...
start_sleep <- boxGrob(glue("9PM Start"),
                       txt_gp = gpar(col = "black"),
                       box_gp = gpar(fill = 0, col =0),
                       y = .7,
                       x = .85,
...
test_wake <- boxGrob(glue("9PM Test"),
                     txt_gp = gpar(col = "black"),
                     box_gp = gpar(fill = 0, col = 0),
                     y = .320,
                     x = .65,
                     ...
                     height = unit(0.05, "npc"),
                     bjust = "top")
test_sleep <- boxGrob(glue("9AM Test"),
                      txt_gp = gpar(col = "black"),
                      box_gp = gpar(fill = 0, col =0),
                      y = .320,
                      x = .85,
...
study_phase <- boxGrob(glue("Study Phase"),
                       txt_gp = gpar(col = "black", fontface = "bold", fontsize = 20),
                       box_gp = gpar(fill = 0, col = 0),
                       x = .5,
                       y = .6,
                       bjust = "center")
...
language_check <- boxGrob(glue("Language/Attention Check"),
                          txt_gp = gpar(col = "black", fontsize = 13),
                          box_gp = gpar(fill = 0, col = 0),
                          x = .5,
                          y = .5,
                          bjust = "center")

stanford_scale <- boxGrob(glue("Stanford Sleepiness Scale (SSS)"),
                          txt_gp = gpar(col = "black", fontsize = 13),
                          box_gp = gpar(fill = 0, col = 0),
                          x = 0.15,
                          y = 0.5,
...
view_wordlist <- boxGrob(glue("View 20 DRM wordlists"),
                         txt_gp = gpar(col = "black", fontsize = 13),
                         box_gp = gpar(fill = 0, col = 0),
                         x = 0.85,
                         y = 0.5,
...
test_phase <- boxGrob(glue("Test Phase"),
                      txt_gp = gpar(col = "black", fontface = "bold", fontsize = 20),
                      box_gp = gpar(fill = 0, col = 0),
                      x = .5,
                      y = .22,
...
free_recall <- boxGrob(glue("Free Recall"),
                       txt_gp = gpar(col = "black", fontsize = 13),
                       box_gp = gpar(fill = 0, col = 0),
                       x = 0.743,
                       y = 0.12,
...
#function for the braces
# x1...y2 are the ends of the brace as coordinates
# for upside down braces, x1 > x2 and y1 > y2
# h is the height -> how much higher the peak is than the body
curly_brace <- function(x1,y1,x2,y2,h) {
  x2 <- x2-x1; y2 <- y2-y1
  v1 <- viewport(x=x1,y=y1,width=sqrt(x2^2+y2^2),
                 height=h,angle=180*atan2(y2,x2)/pi,
                 just=c("left","bottom"),gp=gpar(col="lightblue", lwd = 2))
  pushViewport(v1)
...
pdf(file = "Figures/expprocedure.pdf",
    width = 10,
    height = 5)

#add the images
image_sleep <- magick::image_read("Figures/sleep.tif")
image_wake <- magick::image_read("Figures/wake.tif")

ggdraw() +
  draw_image(image_sleep,
             x = 0.87,
             y = 0.4,
             width = 0.05,
             height = 0.05) +
  draw_image(image_wake,
             x = 0.67,
             y = 0.4,
             width = 0.05,
             height = 0.05)
...
#draw big box around centre part
grid.polygon(x = c(0.01,  0.99,  0.99,  0.01),
             y = c(0.65, 0.65, 0.45, 0.45),
             id = rep(1, 4),
             gp = gpar(col = "black", lwd = 4))

#draw smaller box around lower part
grid.polygon(x = c(0.15, 0.85, 0.85, 0.15),
             y = c(0.27, 0.27, 0.07, 0.07),
             id = rep(1, 4),
             gp = gpar(col = "black", lwd = 4))
...
#from box AM-control
grid.polygon(x = c(0.130, 0.170, 0.170, 0.185, 0.150, 0.115, 0.130),
             y = c(0.775, 0.775, 0.725, 0.725, 0.700, 0.725, 0.725),
             id = rep(1, 7),
             gp = gpar(fill = "#fee59d", col = "black"), draw = TRUE)

#from box PM-control
grid.polygon(x = c(0.330, 0.370, 0.370, 0.385, 0.350, 0.315, 0.330),
             y = c(0.775, 0.775, 0.725, 0.725, 0.700, 0.725, 0.725),
             id = rep(1, 7),
             gp = gpar(fill = "#3276b4", col = "black"), draw = TRUE)


#from box Wake Group
grid.polygon(x = c(0.630, 0.670, 0.670, 0.685, 0.650, 0.615, 0.630),
             y = c(0.775, 0.775, 0.725, 0.725, 0.700, 0.725, 0.725),
             id = rep(1, 7),
             gp = gpar(fill = "#fff1ce", col = "black"), draw = TRUE)

#from box Sleep Group
grid.polygon(x = c(0.830, 0.870, 0.870, 0.885, 0.850, 0.815, 0.830),
             y = c(0.775, 0.775, 0.725, 0.725, 0.700, 0.725, 0.725),
             id = rep(1, 7),
             gp = gpar(fill = "#5e9cd3", col = "black"), draw = TRUE)

#lower row of arrows

#from big box to 9am left
grid.polygon(x = c(0.130, 0.170, 0.170, 0.185, 0.150, 0.115, 0.130),
             y = c(0.447, 0.447, 0.350, 0.350, 0.320, 0.350, 0.350),
             id = rep(1, 7),
             gp = gpar(fill = "#fee59d", col = "black"), draw = TRUE)

#from big box to 9pm left
grid.polygon(x = c(0.330, 0.370, 0.370, 0.385, 0.350, 0.315, 0.330),
             y = c(0.447, 0.447, 0.350, 0.350, 0.320, 0.350, 0.350),
             id = rep(1, 7),
             gp = gpar(fill = "#3276b4", col = "black"), draw = TRUE)

#from big box to 9am right
grid.polygon(x = c(0.630, 0.670, 0.670, 0.685, 0.650, 0.615, 0.630),
             y = c(0.447, 0.447, 0.350, 0.350, 0.320, 0.350, 0.350),
             id = rep(1, 7),
             gp = gpar(fill = "#fff1ce", col = "black"), draw = TRUE)

#from big box to 9pm right
grid.polygon(x = c(0.830, 0.870, 0.870, 0.885, 0.850, 0.815, 0.830),
             y = c(0.447, 0.447, 0.350, 0.350, 0.320, 0.350, 0.350),
             id = rep(1, 7),
             gp = gpar(fill = "#5e9cd3", col = "black"), draw = TRUE)
...
#from Stanford scale to check
grid.polygon(x = c(0.300, 0.355, 0.355, 0.375, 0.355, 0.355, 0.300),
             y = c(0.510, 0.510, 0.530, 0.500, 0.470, 0.490, 0.490))

#from check to DRM
grid.polygon(x = c(0.625, 0.680, 0.680, 0.700, 0.680, 0.680, 0.625),
             y = c(0.510, 0.510, 0.530, 0.500, 0.470, 0.490, 0.490))
...
#from SSS to Survey
grid.polygon(x = c(0.365, 0.420, 0.420, 0.440, 0.420, 0.420, 0.365),
             y = c(0.130, 0.130, 0.150, 0.120, 0.090, 0.110, 0.110))

#from Survey to free recall
grid.polygon(x = c(0.560, 0.615, 0.615, 0.635, 0.615, 0.615, 0.560),
             y = c(0.130, 0.130, 0.150, 0.120, 0.090, 0.110, 0.110))


#curly braces

curly_brace(0.05, 0.84, 0.45, 0.84, 0.05)
curly_brace(0.55, 0.84, 0.95, 0.84, 0.05)
...
#underline study phase
grid.lines(x = c(0.418,0.582),
           y = c(0.57),
           gp = gpar(lwd = 3))

#underline test phase
grid.lines(x = c(0.428, 0.572),
           y = c(0.19),
           gp = gpar(lwd = 3))
